                 ...
                 <div class="card rounded p-4 ">
                     ...
                     <div id="loginAlert"></div>
                      <div class="input-group input-group-lg form-group">
                         <input type="email" name="email" id="email" class="f form-control rounded-0" placeholder="E-mail"  required 
                      ...
                      <div class="form-group ">
                            <div  class="custom-control custom-checkbox  float-left">
                              ...
                              id="customChecked" <?php if(isset($_COOKIE['email'])) { ?> checked<?php } ?>>
                       ...
                       <!--e-mail field-->
                        <div class="input-group  input-group-lg form-group ">
                          <div class="input-group-prepend">
                            ...
                            <input type="email" name="email" id="r-email" class="form-control rounded-0" placeholder="E-Mail"
                            required>
                         </div>
                      <!--end of e-mail field-->
                       ...
                       <!--password field-->
                        <div class="input-group  input-group-lg form-group ">
                          <div class="input-group-prepend">
                            ...
                            <input type="password" name="password" id="rpassword" class="form-control rounded-0" placeholder="Password"
